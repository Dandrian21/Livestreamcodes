var AppProcess = (function () {
  ...
  function removeMediaSenders(rtp_vid_senders){
    for( var con_id in peers_connection_ids){
  ...
  async function videoProcess(newVideoState){
    if(newVideoState == video_states.None){
      ...
      $("#ScreenShareOnOff").html("<span class='material-icons'>present_to_all</span><div>Screenshare</div>");
    ...
    if(newVideoState == video_states.Camera){
      ...
      $("#videoCamOnOff").html("<span class='material-icons'>videocam_off</span>");
      $("#ScreenShareOnOff").html("<span class='material-icons text-success'>present_to_all</span><div class='text-success'>Stop Screenshare</div>");
    }
  }
